...
config :reminderson, RemindersonWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "C9/c4IWNeCDM7Mry/wjfmKY6BXEQsrVNYV9N8+x8okHZebXjILbC9iaX6jG0gN9Q",
  watchers: [
...
config :reminderson, RemindersonWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/reminderson_web/(live|views)/.*(ex)$",
      ~r"lib/reminderson_web/templates/.*(eex)$"
    ]
  ]
