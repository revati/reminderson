defmodule Reminderson.MixProject do
  use Mix.Project
  ...
  def project do
    [
      ...
      compilers: [:boundary, :gettext, :phoenix_live_view] ++ Mix.compilers(),
  ...
  defp aliases do
    [
      ...
      reset: ["ecto.drop", "es.setup", "ecto.setup"],
